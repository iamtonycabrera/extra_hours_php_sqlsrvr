...
// Si no existe la sesion lo devolvemos al index
if (!$_SESSION['activo']) {
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <p class="text-white" style="margin-bottom: 0px;"><?php echo $nombre . " " . $apellido ?></p>
                        <!-- <small class="text-white"><?php echo $dni ?></small> -->
